...
import kopo.jjh.prj.dto.MelonSongDTO;
import kopo.jjh.prj.mongo.impl.IMelonMapper;
import kopo.jjh.prj.service.impl.IMelonService;
...
public class MelonService implements IMelonService {
    ...
    private static final Logger logger = LogManager.getLogger(MelonService.class);
